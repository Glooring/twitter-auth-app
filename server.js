...
const consumerKey = process.env.CONSUMER_KEY || 'v71tqJheXMkovRUcb5UGfylps';
const consumerSecret = process.env.CONSUMER_SECRET || 'uT6fY1GKYlQbmyAK2QpTGzvzVMnWnAKSdqfcubeG6cwh0cfyfa';
